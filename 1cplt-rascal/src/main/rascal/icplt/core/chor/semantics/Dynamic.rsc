...
@autoName test bool _4c9798d5cc35c6d3dc3625a79caa5c02() = reduce(<s2, comm(app("==", [var("i"), val(5)]), val(<"@alice", 5>), "j", asgn("b", val(false)))>) == <s2[chi = {<<"@alice", 5>, seq(asgn("j", val(true)), asgn("b", val(false)))>}], skip()> ;
...
@autoName test bool _7aebeb14f6d2ba34207fc63697db688b() = reduce(<s2, at(val(<"@alice", 5>), asgn("b", val(false)))>) == <s2[phi = s2.phi + ("b": val(false))], skip()> ;
